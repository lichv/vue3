  ...
  <div class="page-wrapper">
    <div class="page-container-header">
      <div class="page-container-header-left">
        <i class="el-icon-menu"></i> <span >区域管理</span>
      </div>
    ...
    <div class="page-content-container">
      <el-card class="page-content-container-left">
        ...
        <div class="page-content-container-content">
          <el-tree ref="tree" :data="regions" show-checkbox node-key="code" :expand-on-click-node="false" :render-content="renderContent" :filter-node-method="filterNode"> </el-tree>
        </div>
      </el-card>
