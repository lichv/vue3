  ...
  <div class="page-wrapper">
    <div class="page-container-header">
      <div class="page-container-header-left">
        <i class="el-icon-menu"></i> <span >我的订单</span>
      </div>
      ...
      <div class="page-container-header-right">
        <el-button size="small"  type="primary" @click="goAddOrder"><i class="el-icon-plus"></i> 添加订单</el-button>
        <el-button size="small"  type="primary"><i class="el-icon-download"></i> 批量录入订单</el-button>
      </div>
    </div>
...
<script>
  export default {
    ...
    methods:{
      ...
      goAddOrder(){
        this.$router.push('/sale/order/orderadd')
      }
    },
    computed:{
