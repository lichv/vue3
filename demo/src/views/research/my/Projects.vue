  ...
  <div class="page-wrapper">
    <div class="page-container-header">
      <div class="page-container-header-left">
        <i class="el-icon-menu"></i> <span >我的用户</span>
      </div>
      <div class="page-container-header-middle">
        
      </div>
      <div class="page-container-header-right">
        <el-button size="small"  type="primary" @click="goAddUser"><i class="el-icon-plus"></i> 新增用户</el-button>
...
<script>
  export default {
    ...
    methods:{
      ...
      goAddUser(){
        this.$router.push('/sale/order/useradd')
      },
    },
    computed:{
