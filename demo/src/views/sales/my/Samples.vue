  ...
  <div class="page-wrapper">
    <div class="page-container-header">
      <div class="page-container-header-left">
        <i class="el-icon-menu"></i> <span >我负责的样本库存</span>
      </div>
      ...
      <div class="page-container-header-right">
        <el-button size="small"  type="primary" @click="goAddSample"><i class="el-icon-plus"></i> 样本采集</el-button>
        <el-button size="small"  type="primary"><i class="el-icon-plus"></i> 批量寄送</el-button>
      ...
      <div class="page-content-container-right white-bg">
        ...
        <div class="page-content-main">
          <el-table stripe :data="tableData" style="width: 100%" height="100%" row-key="id" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
            ...
            <el-table-column fixed prop="code" label="样本条码" width="100" sortable></el-table-column>
            ...
            <el-table-column prop="sample_collector" label="采集器" width="160"></el-table-column>
